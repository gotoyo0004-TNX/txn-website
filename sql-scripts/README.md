...
│   └── 20250825_180000_create_test_admin.sql          # 🧪 測試管理員帳號創建
├── TEST_ADMIN_SETUP.md                               # 🔐 測試帳號設置指南
└── README.md
```
...
5. **執行** `20250825_180000_create_test_admin.sql` (🧪 創建測試管理員，可選)
...
3. **執行** `20250825_180000_create_test_admin.sql` (🧪 測試環境，可選)
...
### 創建測試管理員帳號
為了方便測試管理員功能，我們提供了完整的測試帳號設置：

#### 方法一：自動設置（推薦）
```sql
-- 執行完整的測試環境腳本
sql-scripts/migrations/20250825_180000_create_test_admin.sql
```

#### 方法二：手動設置
請參考 `TEST_ADMIN_SETUP.md` 中的詳細說明
